...
function App() {
  return (
    <>
      <h1>Open React devtool to see re-renders</h1>
      <div className="App">
        <hr />
        normal code below
        <hr />
        ...
        <hr />
        <strong>Bug reproduce</strong>: using div as form without name and radio
        without onchange and defaultChecked
        <hr />
        <MyBuggyForm>
          {new Array(10)
            .fill(1)
        ...
        <hr />
        buggy code below: using div as form with a same name
        <hr />
